...
This document describes the v1 vector retrieval path as currently implemented, including brute-force rerank, qdrant-backed index routing, fallback semantics, and the two-phase retrieval pattern.
