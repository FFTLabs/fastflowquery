# FFQ v1 System Architecture (As Built)

This document describes the architecture implemented in v1 across SQL frontend, analyzer/optimizer, physical planner, execution, storage, shuffle, and distributed coordinator/worker flow.
