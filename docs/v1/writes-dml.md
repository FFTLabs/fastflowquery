# Writes, DML, and Commit Semantics (v1)

This document describes the implemented v1 write path, including SQL DML (`INSERT INTO ... SELECT`), sink operators, DataFrame write APIs, commit behavior, cleanup, and retry/idempotency semantics.
